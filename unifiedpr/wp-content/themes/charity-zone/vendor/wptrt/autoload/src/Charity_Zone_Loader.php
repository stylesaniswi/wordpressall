...
class Charity_Zone_Loader {
	 ...
	 * @return void
	 */
	public function charity_zone_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function charity_zone_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function charity_zone_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function charity_zone_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->charity_zone_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function charity_zone_load( $class ) {
